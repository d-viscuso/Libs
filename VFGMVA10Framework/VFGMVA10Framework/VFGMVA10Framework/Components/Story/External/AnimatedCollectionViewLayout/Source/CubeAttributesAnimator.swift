...
public struct CubeAttributesAnimator: LayoutAttributesAnimator {
    ...
    /// *CubeAttributesAnimator* initializer.
    /// - Parameters:
    ///    - perspective: The perspective that will be applied to the cells. Must be negative. -1/500 by default.
    ///                   Recommended range [-1/2000, -1/200].
    ///    - totalAngle: The higher the angle is, the _steeper_ the cell would be when transforming. .pi/2 by default.
    ...
    public func animate(collectionView: UICollectionView, attributes: AnimatedCollectionViewLayoutAttributes) {
        ...
        if abs(position) >= 1 {
            ...
            if #available(iOS 14.0, *) {
                ...
                contentView.keepCenterAndApplyAnchorPoint(anchorPoint)
            }
