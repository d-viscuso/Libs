//
//  CustomizableTertiaryTileTop.swift
//  VFGMVA10Framework
//
...
/// A class that is used to customize top tertiary tiles in dashboard
/// by providing a component entry of your choice that conform to *VFGComponentEntry*
public class CustomizableTertiaryTileTop: CustomizableTertiaryTileProtocol {
    var componentEntry: VFGComponentEntry?
    /// A closure used to get current component entry type to initialize it later once the *CustomizableTertiaryTileTop* get initialized.
    /// You should use this closure to provide a component entry that would appear as top tertiary tiles in dashboard.
    public static var getCurrentComponentEntry: (() -> VFGComponentEntry.Type)?

    /// *CustomizableTertiaryTileTop* initializer.
    /// - Parameters:
    ...
    required public init(config: [String: Any]?, error: [String: Any]?) {
        let componentEntryType = CustomizableTertiaryTileTop.getCurrentComponentEntry?()
